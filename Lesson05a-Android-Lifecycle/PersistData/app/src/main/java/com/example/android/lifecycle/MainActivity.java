...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFECYCLE_CALLBACKS_TEXT_KEY="textKey";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState!=null){
            if (savedInstanceState.containsKey(LIFECYCLE_CALLBACKS_TEXT_KEY)){
                String data=savedInstanceState.getString(LIFECYCLE_CALLBACKS_TEXT_KEY);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String string=mLifecycleDisplay.getText().toString();
        outState.putString(LIFECYCLE_CALLBACKS_TEXT_KEY,string);
    }
