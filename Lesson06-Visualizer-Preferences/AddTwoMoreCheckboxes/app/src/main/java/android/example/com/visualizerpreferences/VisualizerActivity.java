...
public class VisualizerActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void setupSharedPreferences() {
        ...
        mVisualizerView.setShowMid(sharedPreferences.getBoolean(getString(R.string.pref_mid_range_key),
                getResources().getBoolean(R.bool.pref_mid_range_default)));
        mVisualizerView.setShowTreble(sharedPreferences.getBoolean(getString(R.string.pref_treble_key),
                getResources().getBoolean(R.bool.pref_treble_default)));
    ...
    public void onSharedPreferenceChanged(SharedPreferences sharedPreferences, String key) {
        ...
        if (key.equals(getString(R.string.pref_treble_key))){
            mVisualizerView.setShowBass(sharedPreferences.getBoolean(key, getResources().getBoolean(R.bool.pref_treble_default)));
        }
        if (key.equals(getString(R.string.pref_mid_range_key))){
            mVisualizerView.setShowBass(sharedPreferences.getBoolean(key, getResources().getBoolean(R.bool.pref_mid_range_default)));
        }
    }
