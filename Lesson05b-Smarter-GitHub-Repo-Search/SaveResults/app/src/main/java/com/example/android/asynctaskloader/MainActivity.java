...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_QUERY_URL_RAW_RESULT="result";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            if (savedInstanceState.containsKey(SEARCH_QUERY_URL)) {
                String allPreviousLifecycleCallbacks = savedInstanceState
                        .getString(SEARCH_QUERY_URL);
                mUrlDisplayTextView.setText(allPreviousLifecycleCallbacks);
            }
            if (savedInstanceState.containsKey(SEARCH_QUERY_URL_RAW_RESULT)) {
                String allPreviousLifecycleCallbacks = savedInstanceState
                        .getString(SEARCH_QUERY_URL_RAW_RESULT);
                mSearchResultsTextView.setText(allPreviousLifecycleCallbacks);
            }
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String result=mSearchResultsTextView.getText().toString();
        outState.putString(SEARCH_QUERY_URL, query);
        outState.putString(SEARCH_QUERY_URL_RAW_RESULT, result);
