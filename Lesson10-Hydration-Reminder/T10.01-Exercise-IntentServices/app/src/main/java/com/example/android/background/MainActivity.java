...
public class MainActivity extends AppCompatActivity implements
    ...
    public void incrementWater(View view) {
        ...
        Intent intentWaterCountIntent=new Intent(this, WaterReminderIntentService.class);
        intentWaterCountIntent.setAction(ACTION_INCREMENT_WATER_COUNT);
        startService(intentWaterCountIntent);
